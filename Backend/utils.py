...
def csv_writer(name, threshold_in_time):
    ## parameters
    names_list = np.load(r"known_faces_database\known_face_labels.npy").tolist()
    ...
    csv_out_path = os.path.join(r"database\master_csv", out_csv_name)
